<template>
    <div id="carousel" class="carousel slide show-menu-margin" data-bs-ride="true">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="../../assets/images/slide-10.png" class="d-block w-100" alt="Pessoa com a mão no volante">
                <div class="carousel-caption text-start">
                    <div class="mb-0 fs-title">
                        Negativação e Protesto Online
                    </div>
                    <ul class="mb-1 list-caption ps-0">
                        <li class="list-items">
                            Negativação a nível nacional
                        </li>
                        <li class="list-items">
                            Recupera até 80% dos inadimplentes
                        </li>
                        <li class="list-items">
                            Protesto rápido e fácil
                        </li>
                    </ul>
                </div>
            </div>
